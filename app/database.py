...
def _migrate_schema():
    ...
    migrations = [
        ...
        "ALTER TABLE design_files ADD COLUMN IF NOT EXISTS next_revision_date DATE",
        "ALTER TABLE design_files ADD COLUMN IF NOT EXISTS sent_at TIMESTAMP",
...
def init_db():
    from app.models import client, project, design, activity, project_files, task, social_post, quotation, user, system_log, lead, yarn, vendor, job_card  # noqa: F401
